...
Citizen.CreateThread( function()
    ...
    while true do 
        ...
        if dickheaddebug then
            ...
            drawTxt(0.8, 0.58, 0.4,0.4,0.30, "Armor " .. GetPedArmour(GetPlayerPed(-1)), 55, 155, 55, 255)
            drawTxt(0.8, 0.60, 0.4,0.4,0.30, "H a G: " .. GetEntityHeightAboveGround(GetPlayerPed(-1)), 55, 155, 55, 255)
            drawTxt(0.8, 0.62, 0.4,0.4,0.30, "Model: " .. GetEntityModel(GetPlayerPed(-1)), 55, 155, 55, 255)
            drawTxt(0.8, 0.64, 0.4,0.4,0.30, "Speed: " .. GetEntitySpeed(GetPlayerPed(-1)), 55, 155, 55, 255)
